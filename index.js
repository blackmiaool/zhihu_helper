...
(function (global, factory) {
    ...
    unsafeWindow.$ === undefined && (unsafeWindow.$ = Zepto)
...
(function () {
    ...
    Array.prototype.concat = function (b) {
        function checkExtra(arr) {
            return arr && arr.slice && arr[2] === "来源：知乎";
        }
    ...
    /*民主自由标签*/
    var tipStyle = "color: #0f88eb;font-size: 22px;display: inline-block;position: absolute;top: 0;bottom: 0;line-height: 22px;margin: auto;height: 22px;";
    $(".AppHeader").append($("<span style='" + tipStyle + "left: 10px;" + "'>民主</span>"))
        .append($("<span style='" + tipStyle + "right: 10px;" + "'>自由</span>"));
    /*民主自由标签 end*/
    /*允许复制*/
    !(function(){
        var doa=document.addEventListener;
        document.addEventListener=function(e){
            if(e==='copy'){
                console.log(arguments);
            }else{
                return doa.call(document,...arguments);
            }
        }
    })();
